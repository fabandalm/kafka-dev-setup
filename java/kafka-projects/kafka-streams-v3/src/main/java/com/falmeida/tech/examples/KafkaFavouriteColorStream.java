...
public class KafkaFavouriteColorStream {

    public static void main(String[] args) {

        Properties config = new Properties();
        config.put(StreamsConfig.APPLICATION_ID_CONFIG,"favourite-color-java");
        config.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG,"kubernetes.docker.internal:30092");
        ...
        favouriteColours.toStream().to("favourite-color-output", Produced.with(Serdes.String(), Serdes.Long()));
